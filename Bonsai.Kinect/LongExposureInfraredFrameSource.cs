...
{
    public class LongExposureInfraredFrameSource : Source<TimeInterval<IplImage>>
    {
        public override IObservable<TimeInterval<IplImage>> Generate()
        {
            return KinectManager.DefaultSensor.SelectMany(kinect =>
            {
                return Observable.Using(
                    () => kinect.LongExposureInfraredFrameSource.OpenReader(),
                    reader => Observable.FromEventPattern<LongExposureInfraredFrameArrivedEventArgs>(
