...
{
    public class BodyIndexFrameSource : Source<TimeInterval<IplImage>>
    {
        public override IObservable<TimeInterval<IplImage>> Generate()
        {
            return KinectManager.DefaultSensor.SelectMany(kinect =>
            {
                return Observable.Using(
                    () => kinect.BodyIndexFrameSource.OpenReader(),
                    reader => Observable.FromEventPattern<BodyIndexFrameArrivedEventArgs>(
